...
<asp:Content runat="server" ID="Title" ContentPlaceHolderID="Title">FunnyQuotes Cookies</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <form runat="server">
        <div class="row">
            ...
            <div class="row">
                <div class="large-12 columns">
                    <asp:Button runat="server" ID="btnGetCookie" Text="Show me my FunnyQuotes" OnClick="btnGetCookie_OnClick" CssClass="medium button"/>
